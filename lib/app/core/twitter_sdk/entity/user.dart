...
import 'package:untukmu_social_tools/app/core/twitter_sdk/src/oauth_2.dart';
...
class User {
  ...
  static Future<User> getUserData(
    ...
    try {
      final authParams = requestHeader(apiKey: apiKey, oauthToken: accessToken);
  ...
  static Future<User> getUserDataV2(
    ...
    try {
      ...
      log('TWITTER SDK | getUserDataV2 | token: $token, userId: $userId');
      ...
      log('TWITTER SDK | getUserDataV2 | params: $params');
      ...
      log('TWITTER SDK | getUserDataV2 | userDict: $userDict');

      return User(userDict);
    } on Exception catch (e) {
      log('TWITTER SDK | getUserDataV2 | error: $e');
      rethrow;
    }
  }
}
