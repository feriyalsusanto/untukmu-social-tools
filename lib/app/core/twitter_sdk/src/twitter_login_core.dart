...
import 'package:untukmu_social_tools/app/core/twitter_sdk/entity/auth_result.dart';
import 'package:untukmu_social_tools/app/core/twitter_sdk/entity/user.dart';
import 'package:untukmu_social_tools/app/core/twitter_sdk/schemes/access_token.dart';
import 'package:untukmu_social_tools/app/core/twitter_sdk/schemes/request_token.dart';
import 'package:untukmu_social_tools/app/core/twitter_sdk/src/auth_browser.dart';
import 'package:untukmu_social_tools/app/core/twitter_sdk/src/exception.dart';
...
class TwitterLogin {
  ...
  /// Consumer API client ID
  final String clientId;

  /// Consumer API client secret
  ...
  Future<AuthResult> login({bool forceLogin = false}) async {
    ...
    try {
      if (Platform.isIOS || Platform.isMacOS) {
        ...
        final success = await authBrowser.open(
          requestToken.authorizeURI,
          uri.scheme,
        );
        if (!success) {
  ...
  Future<AuthResult> loginV2({bool forceLogin = false}) async {
    ...
    try {
      ...
      User? user;
      // TODO: implement get user twitter
      // try {
